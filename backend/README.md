...
POSTGRES_PASSWORD=traslatorini2025
POSTGRES_DB=crm_db
...
```
DATABASE_URL=postgresql://translator:traslatorini2025@host:port/crm_db
```
...
`DATABASE_URL=postgresql://translator:traslatorini2025@localhost:5432/crm_db`
