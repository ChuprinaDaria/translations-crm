            ...
            <form onSubmit={handleSubmit(onSubmit)} id="order-form">
              ...
              <TabsContent value="details" className="mt-4 space-y-4 pb-4">
                ...
                <Card className="rounded-xl border-black/5" style={{ backgroundColor: 'var(--color-bg-pink)' }}>
                  <CardContent className="p-4 rounded-xl" style={{ color: 'var(--color-black)', backgroundColor: 'var(--color-bg-purple-light)' }}>
                    {(isDeadlineClose(order.deadline) || isDeadlineOverdue(order.deadline)) && (
                      <p className={cn(
                        "text-xs mb-3",
                        isDeadlineOverdue(order.deadline) ? "text-red-600" : "text-orange-600"
                      )}>
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="space-y-1.5">
                          ...
                          <Textarea
                            ...
                            placeholder={t("orderDetails.orderInfo.notesPlaceholder")}
                          />
                        </div>
                      </div>
                    </div>
